...
function briefBlock(b: any): string {
  return [
    ...
    `International reach: ${b.international ? "YES, must be easy to say and spell across languages (global audience)" : "not a stated requirement"}`,
  ].join("\n");
}
